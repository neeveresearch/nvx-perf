...
For example, the `3.16.29` distribution for the `persistence` module for `linux-x86-64` architecture would be named as `nvx-perf-aep-3.16.29-dist-linux-x86-64.tar.gz`
