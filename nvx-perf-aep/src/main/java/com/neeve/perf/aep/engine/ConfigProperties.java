...
final class ConfigProperties {
    ...
    final static String PROP_CLUSTERING_DISCOVERY_LOCAL_IF_ADDR = "CLUSTER_DISCOVERY_LOCALIFADDR";
    ...
    final static String PROP_CLUSTERING_LINK_READER_CPU_AFFINITY_MASK = "CLUSTERING_LINK_READER_CPU_AFFINITY_MASK";
    final static String PROP_CLUSTERING_LINK_PARAMS = "CLUSTER_LINK_PARAMS";
    ...
    // Engine
    final static String PROP_ENGINE_CAPTURE_PER_TRANSACTION_STATS = "CAPTURE_PER_TRANSACTION_STATS";
    final static String PROP_ENGINE_PER_TRANSACTION_STATS_LOGGING_POLICY = "PER_TRANSACTION_STATS_LOGGING_POLICY";
    final static String PROP_ENGINE_LEG2_IN_STORE_THREAD = "LEG2_IN_STORE_THREAD";
